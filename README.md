...
Content-Type: multipart/form-data; boundary=----WebKitFormBoundaryqOuTjoBBv5W1iXkD
...
Referer: http://localhost:8080/AeroCMS/admin/posts.php?source=add_post
